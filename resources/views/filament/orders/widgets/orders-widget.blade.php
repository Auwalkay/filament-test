        ...
        @foreach($data as $d)
            <div class="grid text-gray-400 gap-y-2 border bg-white p-3 border-gray-200 rounded">
                <div class="flex items-center gap-x-2">
                    ...
                    <svg class="fi-wi-stats-overview-stat-icon h-5 bg-amber-600 rounded w-6 p-1 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
